defmodule BrewDashWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BrewDashWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BrewDashWeb.Gettext, "errors", msg, opts)
    end
  end
